...
EXPECTED_ERROR_MESSAGE = {
    ...
    "image_builder_tiff": [
        "Tif image builder: Could not open file with tifffile.",
        "Tif image builder: Could not open file with OpenSlide.",
        "Tif image builder: Validation error: Not a valid tif: "
